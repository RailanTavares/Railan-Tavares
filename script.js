...
const meusProjetos = [
    ...
    },
    {
        ...
        descricao: "Plataforma de streaming local projetada para gerenciar e transmitir conteúdo multimídia de marketing diretamente para Smart TVs via rede local. Inclui recursos de automação como 'Hora Certa'.",
